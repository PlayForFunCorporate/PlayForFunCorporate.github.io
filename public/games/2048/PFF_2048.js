...
const jeu = `
  <div class="container">
    ...
    <hr>
    <p>
      Modified and implemented by PlayForFun for PlayForFun.fr
    </p>
  </div>
`;
...
function PFF_2048()
{
    return(
        <>
            ...
            <div dangerouslySetInnerHTML={{ __html: jeu}}></div>
            ...
            <iframe src="./PFF_2048.html"></iframe>
        </>
    );
}
export default PFF_2048;